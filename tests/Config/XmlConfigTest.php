...
class XmlConfigTest extends \PHPUnit_Framework_TestCase {
	...
	{
		$this->config1 = new XmlConfig(dirname(dirname(__FILE__)) . '/data-example/xml-config-1.xml');
		$this->config2 = new XmlConfig(dirname(dirname(__FILE__)) . '/data-example/xml-config-2.xml');
	}
